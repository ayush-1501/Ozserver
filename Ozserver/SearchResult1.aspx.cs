...
namespace Ozserver
{
    public partial class WebForm4 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string fromDate= "01-24-2024", toDate, refId;
                ...
                data = SearchByCriteria("ERROR", null,null, null);
        ...
        private void FetchAndStoreData()
        {
            ...
            var apiUrl = "http://crm2.omnix.com.au/OzdocsServerWebAPI/api/EDNDocument/GetEDNData";
        ...
        private List<Branch> SearchByCriteria(string Status, int? id, DateTime? sDateTime, DateTime? rDateTime)
        {
            // Ensure that at least one criterion has a value
            if (Status == null && !id.HasValue && !sDateTime.HasValue && !rDateTime.HasValue)
            {
            ...
            List<Branch> searchResult = branches.FindAll(branch =>
             (Status == null || branch.Status == Status) &&
