            ...
            <div class="col-lg-12 col-md-6 col-sm-3">
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label">DocumentId:</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="DocumentId" runat="server" placeholder="DocumentId" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label">ReferenceId:</label>
                                <div class="col-lg-9">
                           ...
                           <div class="form-group row">
                                 <label class="col-lg-3 col-form-label">Exporter</label>
                                 <div class="col-lg-9">
                             ...
                             <div class="form-group row">
                              ...
                              <div class="form-group row">
                                 <label class="col-lg-3 col-form-label">Buyer</label>
                                 <div class="col-lg-9">
                                    <input type="text" class="form-control" id="Buyer" runat="server" placeholder="Buyer" readonly>
                                 </div>
                             </div>
                             <div class="form-group row">
                                 <label class="col-lg-3 col-form-label">InvoiceValue</label>
                                 <div class="col-lg-9">
