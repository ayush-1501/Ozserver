...
namespace Ozserver
{
    public partial class AQISDocumentData : Page
    {
        int EnteredID;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                // Retrieve values of Role from session state
                if (Session["EnteredID"] != null)
                {
                    EnteredID = (int)Session["EnteredID"];
                }
                else
                {
        ...
        public DataTable GetDataFromDb()
        {
            ...
            apiUrl = apiUrl + "AQISDocument/GetAQISDataById?Id=" + EnteredID;
